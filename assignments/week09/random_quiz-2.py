...
def get_range_hint(number, current_min=1, current_max=100):
    ...
    return f"HINT: The narrowed range around the number is {range(nmber - 12), number +12}"
...
attempt = 1
while True:
    guess_number = int(input("Attemp {attempt} Enter your guess:"))

    if random_number == guess_number:
        print("Congralulation! You won in {attempt} attempts!")
        break
    elif rnadom_number < guess_number:
